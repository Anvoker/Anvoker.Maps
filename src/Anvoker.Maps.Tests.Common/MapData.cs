...
namespace Anvoker.Maps.Tests.Common
{
    ...
    public class MapData<TK, TV>
    {
        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="MapData{TK, TV}"/> class using the specified
        ...
        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="MapData{TK, TV}"/> class by copying members from
        /// another <see cref="MapData{TK, TV}"/> instance.
        /// </summary>
        /// <param name="data">Instance to copy from.</param>
        public MapData(MapData<TK, TV> data)
        {
            if (data == null)
            {
